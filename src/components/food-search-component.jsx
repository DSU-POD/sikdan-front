    ...
    <div className="px-4 py-8">
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="p-4">
            <h3 className="text-lg font-bold mb-2">불닭볶음면</h3>
            <h5 className="text-sm text-gray-400 mb-4">
              (1회 제공량 120g 기준)
            </h5>
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div>
                <span className="font-medium">탄수화물</span> 87.41g
              </div>
              <div>
                <span className="font-medium">단백질</span> 12.38g
              </div>
              <div>
                <span className="font-medium">지방</span> 16.42g
              </div>
            </div>
          </div>
        </div>
